...
export default function RiskAcknowledgementModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      {/* Backdrop */}
      <div className="absolute inset-0 bg-[var(--ink-solid)]/40 backdrop-blur-[2px]" />
      
      {/* Modal Card */}
      <div className="relative w-full max-w-[640px] bg-[var(--surface-secondary)] rounded-[28px] border border-[var(--border-subtle)] shadow-[0_24px_48px_-12px_rgba(255,107,26,0.15)] flex flex-col max-h-[90vh] overflow-hidden">
        
        {/* Header */}
        <div className="p-6 md:p-8 border-b border-[var(--border-subtle)] shrink-0 text-center relative overflow-hidden">
          ...
          <h2 className="relative text-[24px] md:text-[28px] font-black text-[var(--text-primary)] tracking-tight">
            Before you continue
          </h2>
          <p className="relative mt-2 text-[14.5px] font-medium text-[var(--text-secondary)] max-w-[480px] mx-auto leading-relaxed">
        ...
        <div className="p-6 md:p-8 overflow-y-auto space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex gap-4">
              <div className="shrink-0 flex h-10 w-10 items-center justify-center rounded-[12px] bg-[var(--surface-peach)] text-[#FF6B1A] border border-[#FFAB66]/30">
                <AlertTriangle className="h-5 w-5" />
              </div>
              <div>
                <h4 className="text-[15px] font-black text-[var(--text-primary)] mb-1">Speculative Markets</h4>
                <p className="text-[13.5px] text-[var(--text-secondary)] font-medium leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="text-[15px] font-black text-[var(--text-primary)] mb-1">No Ownership Rights</h4>
                <p className="text-[13.5px] text-[var(--text-secondary)] font-medium leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="text-[15px] font-black text-[var(--text-primary)] mb-1">Independent Protocol</h4>
                <p className="text-[13.5px] text-[var(--text-secondary)] font-medium leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="text-[15px] font-black text-[var(--text-primary)] mb-1">Wallet & Contract Risk</h4>
                <p className="text-[13.5px] text-[var(--text-secondary)] font-medium leading-relaxed">
          ...
          <div className="p-4 bg-[var(--surface-primary)] rounded-[16px] border border-[var(--border-subtle)]">
            <p className="text-[13.5px] text-[var(--text-secondary)] font-medium leading-relaxed text-center">
        ...
        <div className="p-6 md:p-8 pt-0 shrink-0 flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-4 text-[13px] font-bold">
            <Link href="/risk-disclaimer" onClick={() => setIsOpen(false)} className="text-[var(--text-muted)] hover:text-[#FF6B1A] transition-colors">
              Read Risk Disclaimer
            </Link>
            <span className="text-[var(--border-strong)]">•</span>
            <Link href="/terms" onClick={() => setIsOpen(false)} className="text-[var(--text-muted)] hover:text-[#FF6B1A] transition-colors">
              Terms of Service
            </Link>
          </div>
