...
export default function RiskDisclosure() {
  return (
    <section className="w-full py-12 bg-[#FFFDFC]">
      <div className="mx-auto max-w-[900px] px-6">
        <FadeIn delay={0.1}>
          <div className="rounded-[24px] border-2 border-[#E9500E]/20 bg-gradient-to-br from-[#FFF1ED] to-[#FFFAF5] p-6 md:p-8 shadow-sm relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-start gap-5 flex-col md:flex-row">
              ...
              <div>
                <h3 className="mb-2 text-[20px] font-extrabold text-[#161616]">Risk Disclosure & Disclaimer</h3>
                <p className="text-[14.5px] font-medium leading-relaxed text-[#5F5B57] mb-5 max-w-[700px]">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  <span className="inline-flex items-center rounded-lg bg-white border border-[#F1DDD0] px-3 py-1.5 text-[13px] font-bold text-[#E9500E]">
                    Highly Speculative
                  </span>
                  <span className="inline-flex items-center rounded-lg bg-white border border-[#F1DDD0] px-3 py-1.5 text-[13px] font-bold text-[#E9500E]">
                    Extreme Volatility
