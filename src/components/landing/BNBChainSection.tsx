...
export default function BNBChainSection() {
  return (
    <section className="w-full bg-[#FFFDFC] py-16 border-b border-[#F2D8C8]">
      <div className="mx-auto max-w-[1080px] px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            <h2 className="text-[28px] md:text-[36px] font-extrabold tracking-tight text-[#161616] mb-5 leading-tight">
              Built for <span className="text-[#FF6B1A]">BNB Chain</span> attention markets
            </h2>
            <p className="text-[16px] font-medium leading-relaxed text-[#5F5B57] mb-8 max-w-[600px] mx-auto lg:mx-0">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3">
              <div className="flex items-center gap-2.5 rounded-xl bg-white border border-[#E8D4C8] px-5 py-2.5 text-[14.5px] font-bold text-[#161616] shadow-sm">
          ...
          <div className="flex-1 w-full flex justify-center">
            <div className="relative w-full max-w-[480px]">
              ...
              {/* Inner card */}
              <div className="relative rounded-[32px] border border-[#F1DDD0] bg-white p-12 shadow-[0_24px_48px_rgba(243,186,47,0.12)] flex flex-col items-center justify-center min-h-[340px]">
                ...
                <div className="flex items-center gap-2.5 rounded-full border border-[#E8D4C8] bg-[#FFFAF5] px-6 py-2.5 text-[14.5px] font-extrabold text-[#161616] shadow-sm">
