...
export default function Hero() {
  return (
    <section className="relative w-full pt-20 pb-10 md:pt-24 md:pb-12 overflow-hidden bg-[var(--surface-tertiary)] -mt-[72px]">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div 
          ...
          style={{
            background: 'linear-gradient(to bottom, var(--surface-tertiary) 0%, var(--surface-tertiary) 40%, var(--surface-peach) 70%, var(--surface-tertiary) 100%)'
          }}
        />
      ...
      <div className="relative mx-auto max-w-[1200px] px-6 text-center z-10 flex flex-col items-center">
        ...
        <FadeIn delay={0.1}>
          <div className="flex flex-col items-center gap-3 mb-6 mt-8">
            <div className="flex flex-wrap justify-center gap-3">
              <div className="flex items-center gap-2 rounded-xl border border-[var(--border-soft)] bg-white/60 backdrop-blur-sm px-4 py-2 text-[13px] font-bold text-[var(--text-primary)] shadow-sm">
            ...
            {/* Trust Pill */}
            <div className="flex items-center gap-2 rounded-full border border-[var(--border-soft)] bg-white/60 backdrop-blur-sm px-4 py-1.5 text-[12px] font-bold text-[var(--text-secondary)] shadow-[0_2px_8px_-4px_rgba(0,0,0,0.05)]">
        ...
        {/* Headline */}
        <FadeIn delay={0.2}>
          <h1 className="mx-auto max-w-[980px] text-[36px] leading-[1.05] tracking-[-0.03em] md:text-[52px] lg:text-[64px] font-[900] text-[var(--text-primary)] mb-4">
            Trade{" "}
        ...
        {/* Subheadline */}
        <FadeIn delay={0.3}>
          <p className="mx-auto max-w-[640px] text-[16px] md:text-[17px] leading-[1.6] text-[var(--text-secondary)] font-medium mb-6">
        ...
        <FadeIn delay={0.4}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
            ...
            <Link
              href="/feed"
              className="flex h-[48px] items-center justify-center rounded-full bg-[var(--surface-primary)] border border-[var(--border-subtle)] px-8 text-[16px] font-bold text-[var(--text-primary)] shadow-sm hover:border-[#FF6B1A] hover:text-[#FF6B1A] transition-colors"
            >
              Explore Markets
            </Link>
          </div>
        ...
        <FadeIn delay={0.5}>
          <div className="flex flex-wrap justify-center gap-x-12 gap-y-3 text-[14px] font-bold text-[var(--text-secondary)] mb-8">
            <div className="flex items-center gap-2.5">
              <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[var(--ink-solid)] text-white">
