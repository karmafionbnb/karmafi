...
function ConnectedNodesIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <line x1="8.4" y1="8.4" x2="15.6" y2="15.6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    ...
    <section className="w-full bg-[var(--surface-tertiary)] py-16 border-b border-[var(--border-subtle)]">
      <div className="mx-auto max-w-[1080px] px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* Card 4 — Multi Chain Ready */}
          <FadeIn delay={0.5}>
            <div className="flex flex-col items-start rounded-3xl border border-[var(--border-soft)] bg-[var(--surface-primary)] p-6 shadow-sm hover:shadow-md transition-shadow h-full">
              <div className="mb-5 flex h-10 w-10 items-center justify-center rounded-xl bg-[#FFAB66]/20 text-[#FF6B1A]">
                <ConnectedNodesIcon className="h-5 w-5" />
              </div>
              <h3 className="mb-2 text-[17px] font-bold text-[var(--text-primary)]">Multi Chain Ready</h3>
              <p className="text-[14.5px] font-medium leading-relaxed text-[var(--text-secondary)]">
                Start on BNB Chain today. Native Solana support is already in development, with more ecosystems planned in the future.
              </p>
            </div>
          </FadeIn>
